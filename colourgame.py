...
# I tried to use a database to collect data before, but it failed.
# This is the code for the database part.
...
def sendemail(cont):
    ...
    receivers = ['colourgame2022@163.com'] 
    content = ",".join(cont)
    title = 'colour game results'
